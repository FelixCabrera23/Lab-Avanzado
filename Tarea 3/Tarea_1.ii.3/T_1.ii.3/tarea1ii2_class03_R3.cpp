...
int main()
{
    ...
    */
    ...
    cout<<  "v1 = " <<  v21 << endl;
    cout<<  "Magnitud de v1: " << v21.Magnitud() << endl;
    ...
    cout << "v3 = v1 + v2 = " << v23 << endl;

    VecR2 v24;

    v24 = v21 + 2*v22;

    cout << "v4 = v1 + 2*v2 = " << v24 << endl;

    cout << "Producto punto" << endl;
    cout << "v1*v2 = " << v21*v22 << endl;
    cout << "v3*v4 = " << v23*v24 << endl;
