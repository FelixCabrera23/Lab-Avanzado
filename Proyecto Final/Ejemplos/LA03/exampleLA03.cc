/* 
 * exampleLA03.cc: Simulación de ejemplo en Geant4.
 * 
...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new LA03DetectorConstruction());
  ...
  runManager->SetUserInitialization(new LA03ActionInitialization());
