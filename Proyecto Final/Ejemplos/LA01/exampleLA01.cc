/* 
 * exampleLA01.cc: Simulación de ejemplo en Geant4.
 * 
...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new LA01DetectorConstruction());
  ...
  runManager->SetUserInitialization(new LA01ActionInitialization());
